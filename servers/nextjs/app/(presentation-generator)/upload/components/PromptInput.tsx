    ...
    <div className="space-y-2">
      <div className="relative">
        <Textarea
          ...
          className={`py-4 px-5 border-2 font-medium font-instrument_sans text-base min-h-[150px] max-h-[300px] border-deep-navy focus-visible:ring-offset-0  focus-visible:ring-deep-navy overflow-y-auto  custom_scrollbar  `}
        />
      </div>
      <p
