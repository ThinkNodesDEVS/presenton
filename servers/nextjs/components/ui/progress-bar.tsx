  ...
  return (
    <div className="w-full space-y-2">
      ...
      <div className="w-full bg-white rounded-full h-2 overflow-hidden">
        <div
          className="h-full bg-gradient-to-r from-electric-orange via-deep-navy to-electric-orange rounded-full animate-gradient transition-all duration-300 ease-out"
          style={{
            width: `${progress}%`,
