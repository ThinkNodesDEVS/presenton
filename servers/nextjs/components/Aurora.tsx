...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    // Type guard to ensure we're working with HTMLCanvasElement
    ...
    // Type guard to ensure we can append to DOM
    if (gl.canvas instanceof HTMLCanvasElement) {
      ctn.appendChild(gl.canvas);
    }

    // Debug: log to ensure WebGL is working
  ...
  return (
    <div
      ref={ctnDom}
      className="aurora-container absolute inset-0 w-full h-full pointer-events-none"
      style={{
